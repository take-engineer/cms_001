						...
						<article class="p-post">
							<div class="p-post-meta">
								<p class="p-post-meta-item">
									<time class="p-post-meta-date" datatime="<?php the_time('Y.n.j');?>"><?php the_time('Y.n.j');?></time>
								</p>
								<p class="p-post-meta-item">
									<span class="p-post-meta-cat"><?php my_the_post_category( true ); ?></span>
								</p>
							</div>
							<h1 class="p-post-ttl"><?php the_title(); ?></h1>
								...
								<?php
									if(has_post_thumbnail()):?>
										<?php
											...
											'class' => 'p-post-eyecatch-img',
											'alt' => get_the_title(),
										)); ?>
									<?php else: ?>
										<img class="p-post-eyecatch-img" src="<?= get_template_directory_uri(); ?>/img/noimage.png" alt="">
									<?php endif; ?>
							</figure>
							<div class="p-post-content"><?php the_content(); ?></div>
						</article>
